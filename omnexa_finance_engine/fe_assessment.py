...
from omnexa_finance_engine.fe_gap_register import get_gap_status
from omnexa_finance_engine.fe_global_benchmark import get_global_fe_score

@frappe.whitelist()
def export_fe_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_OMNEXA_FINANCE_ENGINE_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_fe_score(), get_gap_status()
