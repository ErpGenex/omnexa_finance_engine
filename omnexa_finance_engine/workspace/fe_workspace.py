...
"""Full Finance Engine workspace — SAP SD / Van Sales parity catalog."""
...
WORKSPACE_NAME = "Finance Engine"

_SHORTCUT_COLORS = ("Blue", "Green", "Orange", "Red", "Cyan", "Purple", "Teal", "Pink", "Yellow")

WORKSPACE_SECTIONS: list[tuple[str, list[WorkspaceLink]]] = [('📊 Dashboards', [('Page', 'fe-executive-dashboard', 'Executive Dashboard'), ('Page', 'fe-servicing-portal', 'Servicing Portal')]), ('🏦 Finance engine core', [('DocType', 'Finance Product', 'Finance Product'), ('DocType', 'Finance Contract Account', 'Contract Account'), ('DocType', 'Finance Calc Run', 'Calc Run'), ('DocType', 'Finance Scenario Run', 'Scenario Run')]), ('📤 Events & templates', [('DocType', 'Finance Event Outbox', 'Event Outbox'), ('DocType', 'Finance Accounting Event Template', 'Accounting Template'), ('DocType', 'Finance Policy Version', 'Policy Version')]), ('📈 Finance reports', [('Report', 'General Ledger', 'General Ledger'), ('Report', 'Trial Balance', 'Trial Balance'), ('Report', 'Governance Overview', 'Governance Overview')])]

_REMOVED_SECTIONS = [
	(
		"📊 Dashboards & Mobile",
		[
			("Page", "fe-executive-dashboard", "Executive Dashboard"),
			("Page", "fe-van-sales-pwa", "Van Sales PWA"),
		],
	),
	(
		...
		[
			...
			("DocType", "Finance Engine Vehicle", "Finance Engine Vehicle"),
			("DocType", "Finance Engine Sales Representative", "Sales Representative"),
		],
	),
	(
		"🚚 Field Sales & Distribution",
		[
			("DocType", "Finance Engine Route Plan", "Route Plan"),
			("DocType", "Finance Engine Distribution Order", "Distribution Order"),
			("DocType", "Finance Engine Van Sales Invoice", "Van Sales Invoice"),
			("DocType", "Finance Engine Vehicle Stock Transfer", "Vehicle Stock Transfer"),
		],
	),
	(
		"💰 Commissions & Incentives",
		[
			("DocType", "Finance Engine Commission Rule", "Commission Rule"),
			("DocType", "Finance Engine Commission Settlement", "Commission Settlement"),
		],
	),
	(
		"📋 Tenders & Credit",
		[
			("DocType", "Finance Engine Tender", "Tender"),
			("DocType", "Finance Engine Installment Contract", "Installment Contract"),
		],
	),
	(
		"💳 Finance & ERP",
	...
	(
		...
		[
			("Report", "Finance Engine Sales Summary", "Sales Summary"),
			("Report", "Finance Engine Distribution Fulfillment", "Distribution Fulfillment"),
			("Report", "Finance Engine Vehicle Transfer Summary", "Vehicle Transfer Summary"),
			("Report", "Finance Engine Route Efficiency", "Route Efficiency"),
			("Report", "Finance Engine Rep Target Tracking", "Rep Target Tracking"),
		],
	),
	(
		"📈 Reports · Commissions & Pipeline",
		[
			("Report", "Finance Engine Commission Summary", "Commission Summary"),
			("Report", "Finance Engine Tender Pipeline", "Tender Pipeline"),
			("Report", "Finance Engine Installment Portfolio", "Installment Portfolio"),
		],
	),
	(
		"📈 Reports · Finance & POS",
...
def _build_link_rows() -> list[dict]:
	return build_link_rows_for_app("omnexa_finance_engine", WORKSPACE_SECTIONS)
...
def _build_content(link_rows: list[dict], ws) -> str:
	...
	content.append(
		{
			"id": "fe-title",
			"type": "header",
			"data": {"text": '<span class="h4"><b>Finance Engine</b></span>', "col": 12},
		}
	)
	section_idx = 0
	link_idx = 0
	for row in link_rows:
		if row.get("type") == "Card Break":
			if section_idx:
				content.append({"id": f"fe-sp-{section_idx}", "type": "spacer", "data": {"col": 12}})
			content.append(
				{
					"id": f"fe-sec-{section_idx}",
					"type": "header",
	...
	if ws.number_cards:
		content.append({"id": "fe-kpi-sp", "type": "spacer", "data": {"col": 12}})
		content.append(
			{
				"id": "fe-kpi-h",
				"type": "header",
	...
	if ws.charts:
		content.append({"id": "fe-ch-sp", "type": "spacer", "data": {"col": 12}})
		content.append(
			{
				"id": "fe-ch-h",
				"type": "header",
...
def sync_fe_workspace_menu(*, save: bool = True, rebuild: bool = True) -> dict:
